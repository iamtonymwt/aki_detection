...
from handler.data_processor import get_patient_history, load_and_process_history
from handler.hl7_processor import parse_hl7_message, extract_mrn
from handler.listener import receive_message, close_connection, ack_message, start_listener
from handler.aki_detector import load_model, predict_aki, aggregate_data
...
class AKIModelIntegrationTesting(unittest.TestCase):
    def setUp(self):
        ...
        self.historical_data = load_and_process_history('../data/history.csv')
